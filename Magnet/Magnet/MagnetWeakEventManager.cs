...
namespace Magnet
{
    class MagnetWeakEventManager : WeakEventManager
    {
        private MagnetWeakEventManager()
        {
        ...
        /// </summary>
        private static MagnetWeakEventManager CurrentManager
        {
            get
            {
                Type managerType = typeof(MagnetWeakEventManager);
                MagnetWeakEventManager manager =
                    (MagnetWeakEventManager)GetCurrentManager(managerType);

                // at first use, create and register a new manager
                if (manager == null)
                {
                    manager = new MagnetWeakEventManager();
